...
/**
  ...
  * @since 8/22/16.
  */
case class CompressedState(appStart: Option[SparkListenerApplicationStart],
                           coreUsage: Map[TaskLocality, CompressedMetricsSink],
                           executorInfo: Map[String, SparklintExecutorInfo],
                           stageMetrics: Map[StageIdentifier, CompressedStageMetrics],
