...
/**
  ...
  * @since 8/18/16.
  */
case class BufferedEventSource(defaultAppId: String, eventState: EventStateLike)
  ...
  override def appId: String = eventState.getState.appId.getOrElse(defaultAppId)
